...
(function(){
  ...
  const rgb2hex = ({r,g,b})=>{
    ...
    return '#'+h(comp(r))+h(comp(g))+h(comp(b));
  };

  const update = ()=>{
    const a = hex2rgb(A.value);
    const b = hex2rgb(B.value);
    const t = Number(R.value)/100;
    const mix = {
      r: a.r*(1-t) + b.r*t,
      g: a.g*(1-t) + b.g*t,
      b: a.b*(1-t) + b.b*t
    ...
    pctA.textContent = (100 - Number(R.value));
    pctB.textContent = R.value;
  };
