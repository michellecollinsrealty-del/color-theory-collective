// Netlify serverless function: proxies to OpenAI and gates access by Member Pass.
export async function handler(event, context) {
  ...
  try {
    ...
    // Choose a model (adjust if you prefer a different one)
    const model = (tier === "elite" || tier === "pro") ? "gpt-4o" : "gpt-4o-mini";
